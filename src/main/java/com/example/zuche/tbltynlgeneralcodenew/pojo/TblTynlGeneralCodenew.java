package com.example.zuche.tbltynlgeneralcodenew.pojo;
...
@ApiModel(value="TblTynlGeneralCodenew对象", description="系统编码表，并发量高，读写表")
public class TblTynlGeneralCodenew implements Serializable {
