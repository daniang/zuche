package com.example.zuche.tbltynlgeneralcode.pojo;
...
@ApiModel(value="TblTynlGeneralCode对象", description="系统编码表，并发量高，读写表")
public class TblTynlGeneralCode implements Serializable {
